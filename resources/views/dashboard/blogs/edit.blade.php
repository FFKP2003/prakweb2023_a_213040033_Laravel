    ...
    <form method="post" action="/dashboard/blogs/{{ $blog->slug }}" class="mb-5" enctype="multipart/form-data">
      ...
      @csrf
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('tittle') is-invalid @enderror" id="tittle" name="tittle" required autofocus value="{{ old('tittle', $blog->tittle) }}">
          @error('tittle')
      ...
      <script>
        ...
        tittle.addEventListener('change', function() {
          fetch('/dashboard/blogs/checkSlug?tittle=' + tittle.value)
